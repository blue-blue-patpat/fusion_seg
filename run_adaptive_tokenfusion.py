...
def main(args):
    ...
    args.enabled_inputs = args.enabled_inputs.replace(' ','').split(',')
    args.data_path = '/home/nesc525/drivers/0/dataset' if args.read_orig_img else '/home/nesc525/drivers/7/mmBody'
...
def parse_args():
    ...
    parser.add_argument('--enabled_inputs', type=str, default='radar,master_image,master_depth,sub_image,sub_depth', help='input data')
    # P4D
