...
class DeviceManager:
    ...
    def enable_emitter(self, enable_ir_emitter=False):
        """
    ...
    def get_depth_to_color_extrinsics(self, frames):
        ...
        for (serial, frameset) in frames.items():
            ...
            extrinsics_r[serial]=device_extrinsics[serial].rotation            
            extrinsics_t[serial]=device_extrinsics[serial].translation
            
        return device_extrinsics,extrinsics_r,extrinsics_t
